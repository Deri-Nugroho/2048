...
#   Tidak perlu --tls-san.
#
# Project: 2048 Game (FastAPI + Uvicorn)
# Image  : debuglifeindonesia/cohort-01:latest
...
echo "  Project: 2048 Game (FastAPI)"
echo "======================================================"
echo ""
...
echo ""
echo "──────────────────────────────────────────────────────"
echo "  INFO DEPLOY — 2048 Game"
echo "──────────────────────────────────────────────────────"
echo "  Image    : ghcr.io/deri-nugroho/game-2048:latest"
echo "  Manifest : k8s/manifest.yaml (Deployment + Service)"
echo "  App Port : 8080 (container)"
echo "  NodePort : 30080 (akses dari browser)"
echo ""
echo "  Setelah pipeline jalan, buka:"
echo "  http://$EC2_PUBLIC_IP:30080"
echo ""
echo "  Pastikan Security Group EC2 membuka port 30080!"
echo "──────────────────────────────────────────────────────"
echo ""
